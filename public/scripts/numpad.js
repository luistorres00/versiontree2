export function preencherPopupComDetalhes(detalhes) {
...
export  function generateNumpad() {
...
export  function generateNumpad2() {
    //Se já existir um numpad gerado, não acrescenta mais um
...
export  function generatePositionButtons(detalhes) {
