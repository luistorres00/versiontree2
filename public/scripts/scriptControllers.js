import { checkPassword, checkPassword2, updatePosition } from "./dbacess";
import { preencherPopupComDetalhes, generateNumpad, generateNumpad2, carregarDados, handleEnterKey, generatePositionButtons, updateClock } from "./numpad";
import { inputRace, limparLS, abrirDetalhes, abrirPopup, abrirPopup2, abrirPopupNumpad, abrirPopupNumpadPassword, abrirPopupRodaDentada,
        abrirPopupConfiguracoes, abrirPopupFiltros, fecharPopup, fecharPopup2, fecharPopupConfiguracoes, fecharPopupFiltros, fecharPopupNumpad,
        fecharPopupNumpadPassword, fecharPopupRodaDentada, fecharPopup, fecharPopup2, fecharPopupConfiguracoes, trocarParaNumpad,
        editarNumpad, editarNumpad2, carregarNumpad, carregarNumpad2, refreshPage, atualizarEstadoCheckbox, scrollToBottomWithDelay} from "./pagina";
import { mudaPesquisa, pesquisaEscolhaPostObs, pesquisarTabelaHour, pesquisarTabelaPost, pesquisaEscolhaPost, pesquisaEscolhaPostObs, pesquisarTabelaObs } from "./pesquisa";
import { adicionarCameraOrPost, atualizarHoraAtual, adicionarLinha, updateLinha, deleteLinha, atualizarTabela, limparTabela, trocarParaTabela, moveUp, moveDown, 
        obterCurvaNum, obterHoraAtual, obterStartOrRF} from "./tabela";
