  ...
  export function pesquisarTabelaObs() {
    // Declare variables
  ...
  export function pesquisarTabelaHour() {
    // Declare variables
    var input, filter, table, tr, td, i, txtValue;
    input = document.getElementById("pesquisa");
    filter = input.value.toUpperCase();
  ...
  export function pesquisarTabelaPost() {
    // Declare variables
    var input, filter, table, tr, td, i, txtValue;
    input = document.getElementById("pesquisa");
    filter = input.value.toUpperCase();
  ...
  export function pesquisaEscolhaPost() {
  ...
  export function pesquisaEscolhaPostObs() {
