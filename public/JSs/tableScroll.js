...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var posicaoScrollVertical = localStorage.getItem("posicaoScrollVertical");
    var posicaoScrollHorizontal = localStorage.getItem("posicaoScrollHorizontal");
    ...
    tableContainer.addEventListener('scroll', function() {
        localStorage.setItem("posicaoScrollVertical", tableContainer.scrollTop);
        localStorage.setItem("posicaoScrollHorizontal", tableContainer.scrollLeft);
    });
